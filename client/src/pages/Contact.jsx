...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Handle form submission - can integrate with backend later
    window.location.href = `mailto:info@agrifineconsulting.com?subject=Contact from ${formData.name}&body=${encodeURIComponent(formData.message)}`;
  };
      ...
      <section className="bg-gradient-to-r from-green-600 to-green-700 dark:from-green-800 dark:to-green-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-green-100">
            Get in touch with Agrifine Consulting
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      <a href="tel:+254722446735" className="hover:text-primary">0722446735</a><br />
                      <a href="tel:+254721329314" className="hover:text-primary">0721 329 314</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      <a href="mailto:info@agrifineconsulting.com" className="hover:text-primary">
